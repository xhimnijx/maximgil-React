          ...
          >
            ...
            <div className="features24-content1">
              <h2 className="thq-heading-2">
                {props.feature1Title ?? (
                  <Fragment>
                    <span className="features24-text4">AS Level Physics</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.feature1Description ?? (
                  <Fragment>
                    <span className="features24-text1">
                      Passionate about understanding the laws of the universe.
                    </span>
                  </Fragment>
                )}
              </span>
          ...
          >
            ...
            <div className="features24-content2">
              <h2 className="thq-heading-2">
                {props.feature2Title ?? (
                  <Fragment>
                    <span className="features24-text3">Tech Enthusiast</span>
                  </Fragment>
                )}
              </h2>
              <span className="thq-body-small">
          ...
          >
            ...
            <div className="features24-content3">
              <h2 className="thq-heading-2">
                {props.feature3Title ?? (
                  <Fragment>
                    <span className="features24-text2">AI Projects</span>
                  </Fragment>
                )}
              </h2>
              <span className="thq-body-small">
...
Features24.defaultProps = {
  ...
  feature1ImgAlt: 'Physics Experiment',
  feature2Title: undefined,
  feature1Title: undefined,
  feature2ImgAlt: 'Tech Innovation',
  feature3ImgAlt: 'AI Technology',
